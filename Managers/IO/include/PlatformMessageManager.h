#ifndef ULTREALITY_CORE_PLATFORM_MSG_MANAGER_H
#define ULTREALITY_CORE_PLATFORM_MSG_MANAGER_H
...
namespace UltReality::IO
{
	...
	/// </summary>
	struct PlatformMessageEvent : public Utilities::EventBase_t<PlatformEvents>
	{
	...
	/// <summary>
	/// Singleton class the provides a MsgProc method to be used as the platform's message handler and dispatches platform level events
	/// </summary>
	class PlatformMessageManager : public Utilities::EventSource_t<PlatformMessageEvent>
	{
	private:
		PlatformMessageManager() = default;

	public:
		static PlatformMessageManager& GetInstance();

		void ProcessPlatformMessages();

		void PostQuit(const EWindowDestroy&);
		...
		PlatformMessageManager(const PlatformMessageManager&) = delete;
		PlatformMessageManager& operator=(const PlatformMessageManager&) = delete;

		PlatformMessageManager(PlatformMessageManager&&) = delete;
		PlatformMessageManager& operator=(PlatformMessageManager&&) = delete;
	};
}

#endif // !ULTREALITY_CORE_PLATFORM_MSG_MANAGER_H
