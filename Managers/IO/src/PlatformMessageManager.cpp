#include <PlatformMessageManager.h>

namespace UltReality::IO
{
	PlatformMessageManager& PlatformMessageManager::GetInstance()
	{
		static PlatformMessageManager instance;
		return instance;
	}
...
#include <windowsx.h>
	...
	void PlatformMessageManager::ProcessPlatformMessages()
	{
		MSG msg = { 0 };
	...
	void PlatformMessageManager::PostQuit(const EWindowDestroy&)
	{
		PostQuitMessage(0);
	}

	LRESULT PlatformMessageManager::MsgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
	{
		switch (msg)
		{
